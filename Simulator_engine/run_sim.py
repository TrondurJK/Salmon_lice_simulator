...
def run_sim(delta_time, inital_start, stop_time, system):
    ...
    stages_f_list = [[[] for _ in range(6)] for _ in farms]
    stages_m_list = [[[] for _ in range(5)] for _ in farms]
    ...
    while t < stop_time:
        ...
        for id, (
            ...
            Ch1_f, Ch2_f, Pa1_f, Pa2_f, A_f, AG_f, Ch1_m, Ch2_m, Pa1_m, Pa2_m, A_m = [
                x / max(1, farm.fish_count) for x in farm.get_fordeiling()
            ]

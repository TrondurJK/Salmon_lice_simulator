...
def run_sim(delta_time, stop_time, system, inital_start):
    ...
    while t < stop_time:
        ...
        for farm, stages_f,stages_m, index, fish_count_save, clean_fish_save, attached_save in zip(farms, stages_f_list, stages_m_list, indexis, fish_count_save_list, clean_fish_save_list,attached_save_list):
    ...
    return index, stages_f_list, stages_m_list, fish_count_save_list,clean_fish_save, farm.name

...
treat_automatic_thres[1][
    np.logical_and(treat_automatic_thres[2] > 121, treat_automatic_thres[2] < 121 + 90)
] = 0.2
...
farms = [
    Farm(
        delta_time,
        1_000_000,
        L_0=10000,  # number of larvea per day
...
system = System(farms=farms, c_matrix=Con_matrix, dayofyear_0=True)
